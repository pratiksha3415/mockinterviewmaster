    ...
    <div className="min-h-screen overflow-hidden relative">
      ...
      <motion.div style={{ opacity }} className="fixed bottom-8 right-8 z-40">
        <Link to="/auth?type=register">
          <Button className="bg-gradient-to-r from-blue-500 to-purple-600 hover:bg-gradient-to-r hover:from-blue-600 hover:to-purple-700 rounded-full p-6 shadow-lg transition-all duration-300 hover:shadow-blue-400/20 hover:shadow-xl">
            Get Started
          </Button>
        </Link>
      </motion.div>
      ...
      <section className="py-20 relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 text-center">
          ...
          >
            <Link to="/auth?type=register">
              <Button className="bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 text-white px-8 py-6 rounded-lg text-lg h-auto font-medium hover-lift">
                Start Free Practice
              </Button>
            </Link>
          </motion.div>
      ...
      <footer className="py-8 bg-gradient-to-r from-gray-100 to-gray-200">
        <div className="container mx-auto px-6">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="text-xl font-semibold mb-4 md:mb-0 bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-purple-600">MockMaster</div>
